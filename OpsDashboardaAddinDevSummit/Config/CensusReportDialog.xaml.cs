...
namespace CensusReport.Config
{
  ...
  public partial class CensusReportDialog : Window, INotifyPropertyChanged
  {
    ...
    /// <summary>
    /// Data source selected by the op. view author from the DataSourceSelector control
    /// </summary>
    ...
    private void OKButton_Click(object sender, RoutedEventArgs e)
    {
      ...
      //because the generate report service needs an input geometry, but for non map-based data sources (aka. external data source) 
